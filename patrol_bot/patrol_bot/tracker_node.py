...
class TrackerNode(Node):
    def __init__(self):
        ...
        # 2. Initialize YOLOv26
        self.get_logger().info("Loading YOLOv26 model...")
    ...
    def process_frame(self):
        ...
        try:
            ...
            if results[0].boxes.id is not None:
                ...
                # Extract confidences if available (usually yes)
                ...
                for box, track_id, conf in zip(boxes, track_ids, confs):
                    ...
                    cv2.putText(res_plotted, f"ID: {track_id} ({conf:.2f})", (int(x), int(y)), 
